    ...
    let scanDirectory = async (directory: string) => {
        ...
        for (let file of files) {
            ...
            if (document == undefined) {
                ...
                console.log(`document.fileLastWriteTime = ${document.fileLastWriteTime.Node.ToString("O")}(${document.fileLastWriteTime.Ticks}) = ${fileUtils.lastWriteTime(file).ToString("O")}(${fileUtils.lastWriteTime(file).Ticks}) = ${document.fileLastWriteTime != fileUtils.lastWriteTime(file)}`);
